...
/**
 * Author: Aadil Farouk Date: 5/12/13 Time: 3:40 PM
 */
...
public class PriceWrapper
{
	...
	private HashMap<Integer, Integer> lookup(final Integer... ids)
	{
		...
		try (final BufferedReader in = new BufferedReader(new InputStreamReader(new URL(add).openConnection().getInputStream())))
		{
